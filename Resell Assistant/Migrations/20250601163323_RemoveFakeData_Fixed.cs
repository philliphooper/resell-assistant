...
namespace Resell_Assistant.Migrations
{
    ...
    public partial class RemoveFakeData : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.Sql("DELETE FROM PriceHistories;");
            migrationBuilder.Sql("DELETE FROM UserPortfolios;");
            migrationBuilder.Sql("DELETE FROM SearchAlerts;");
            migrationBuilder.Sql("DELETE FROM Products;");
            
            // Reset identity sequences to start from 1
            migrationBuilder.Sql("DELETE FROM sqlite_sequence WHERE name IN ('Products', 'Deals', 'SearchAlerts', 'PriceHistories', 'UserPortfolios');");
        }
